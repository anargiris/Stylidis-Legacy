        ...
        <AnimatePresence>
          ...
          >
            <motion.div className="relative z-10">
              ...
              <Link href="/contact">
                <motion.div
                  className="cursor-pointer text-center text-xl text-blue-50 bg-gradient-to-l from-indigo-700 to-indigo-800 border-2 border-gray-300 px-2 py-1 w-24 mx-auto rounded-md font-bold  transition duration-200"
